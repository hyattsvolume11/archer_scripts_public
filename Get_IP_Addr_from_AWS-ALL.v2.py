...
#  Build CSV file from EC2 instance IP address data based on Application/System Tag and Enviroment Tag(s)
...
# my_SYS = System Tag in AWS =>  Service/Application/System Name
...
# csv_file.write(str(my_list) + "," + my_SYS + "," + my_Env + "\n")

# Example 1 
# my_SYS = SharePoint_Example_01
# Env = Stage 
# Date Added 12/21/21
filters = [
